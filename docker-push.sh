...
then
  ...
  if [[ "$TRAVIS_BRANCH" == "staging" ]]; then
    ...
    export REACT_APP_EXERCISES_SERVICE_URL="http://testdriven-staging-alb-1752140886.us-west-1.elb.amazonaws.com"
    export REACT_APP_SCORES_SERVICE_URL="http://testdriven-staging-alb-1752140886.us-west-1.elb.amazonaws.com"
  elif [[ "$TRAVIS_BRANCH" == "production" ]]; then
    export DOCKER_ENV=prod
    export REACT_APP_USERS_SERVICE_URL="http://testdriven-production-alb-1003607086.us-west-1.elb.amazonaws.com"
    export REACT_APP_EXERCISES_SERVICE_URL="http://testdriven-production-alb-1003607086.us-west-1.elb.amazonaws.com"
    export REACT_APP_SCORES_SERVICE_URL="http://testdriven-production-alb-1003607086.us-west-1.elb.amazonaws.com"
    export DATABASE_URL="$AWS_RDS_URI"
    python3export SECRET_KEY="$PRODUCTION_SECRET_KEY"
  fi
