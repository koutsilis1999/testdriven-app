...
class TestUserService(BaseTestCase):
    ...
    def test_add_user_invalid_json(self):
        """Ensure that error is thrown if the JSON object is empty """
        with self.client:
            response = self.client.post(
    ...
    def test_add_user_invalid_json_key(self):
        """Ensure that error is thrown if the Json object does not have a username key"""
        with self.client:
            response = self.client.post(
                "/users",
    ...
    def test_add_user_duplicate_email(self):
        """Ensure that error is thrown if email already exists"""
        with self.client:
            self.client.post(
                "/users",
                data=json.dumps(
    ...
    def test_all_users(self):
        """Ensure that get all users behaves correctly."""
        add_user("michael", "michael@mherman.org")
        add_user("fletcher", "fletcher@notreal.com")
        with self.client:
            resposne = self.client.get("/users")
    ...
    def test_main_no_users(self):
        """Ensure that the main route behaves correctly when no users have benn added to the db"""
    ...
    def test_main_with_users(self):
        """Ensure that the main route behaves correctly when users have been added to the db"""
        add_user("michael", "michael@mherman.org")
        add_user("fletcher", "fletcher@notreal.com")
        with self.client:
            response = self.client.get("/")
    ...
    def test_main_add_user(self):
        """Ensure that a new user can be added to the db via post request"""
        with self.client:
            response = self.client.post(
                "/",
